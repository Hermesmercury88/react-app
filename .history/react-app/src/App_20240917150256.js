...
// ตัวอย่างการทำงานของ useAuth (แทนที่ด้วยการตรวจสอบการใช้งานจริงของคุณ)
const useAuth = () => {
  // ตำแหน่งการตรวจสอบการเข้าสู่ระบบของผู้ใช้จริงของคุณ
  const user = false; // เปลี่ยนเป็นการตรวจสอบการเข้าสู่ระบบจริง
  return { user };
};
