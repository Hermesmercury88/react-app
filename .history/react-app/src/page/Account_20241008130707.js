    ...
    return (  
        ...
        <>
            ...
            <h1> รูปโปรไฟล์ : {picture ? (
                ...
                <div className="my-3 flex justify-center "><button onClick={() => setShowModal(true)} className="p-2 bg-red-500 rounded hover:bg-red-400">แก้ไขข้อมูล </button>
    ...
    <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-re-500"
        />
      </div>
